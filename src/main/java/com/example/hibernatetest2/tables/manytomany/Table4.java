...
public class Table4 {
    ...
    @OneToMany(mappedBy = "myOneAndOnlyTable4", // Variable name in Table3Table4 that points to Talbe4.id
               orphanRemoval = true) // If true, deletes entire row in Table3Table4 when Table4 is deleted
    @Builder.Default
